...
- Formula: unsigned tarballs containing `bin/agent-gateway`.
...
```text
dist/homebrew/agent-gateway-<version>-darwin-arm64.tar.gz
dist/homebrew/agent-gateway-<version>-darwin-arm64.tar.gz.sha256
dist/homebrew/agent-gateway-<version>-darwin-x64.tar.gz
dist/homebrew/agent-gateway-<version>-darwin-x64.tar.gz.sha256
```
...
```bash
scripts/render-homebrew-formula.sh <version> ../homebrew-tap/Formula/agent-gateway.rb
```
...
dist/homebrew-cask/agent-gateway-<version>-darwin-arm64.dmg.sha256
dist/homebrew-cask/agent-gateway-<version>-darwin-x64.dmg
dist/homebrew-cask/agent-gateway-<version>-darwin-x64.dmg.sha256
```

Render the Cask:

```bash
scripts/render-homebrew-cask.sh <version> ../homebrew-tap/Casks/agent-gateway.rb
```
...
```bash
ruby -c Formula/agent-gateway.rb
brew audit --strict agent-gateway || brew audit --strict --formula agent-gateway
